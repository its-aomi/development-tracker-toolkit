...
The tracker site is built with [Next.js](https://nextjs.org/), a [development framework](https://www.toolbox.com/tech/devops/blogs/what-is-a-development-framework-why-use-a-development-framework-042911/) that uses [React](https://reactjs.org/), a JavaScript library for building user interfaces. Airtable’s API key is used to connect your Airtable base to the site, and each row of data about a single real estate development project becomes a page on the tracker site. The site uses several additional tools, like Mapbox, and is hosted on Netlify. We'll walk you through our narrow uses of these programs and tools later in this guide. 
...
This guide starts with some initial considerations: [what you will need](./what-you-will-need) to complete this project and [initial questions](./initial-questions-to-ask) you should ask as you’re planning to bring a development tracker to your newsroom. 

Then, it discusses what kinds of [data you’ll need to gather](./starting-with-the-data) and how you can go about collecting it. 

Next, it walks you through [using Airtable](./organize-your-data-airtable-basics), creating [your copy of the Airtable template](./setting-up-your-airtable-base) and how you will enter your data there. 

Then, you will [set up your tracker site](./setting-up-the-site) and [customize necessary components](./customizing-the-site). After that, you will be shown how to [publish the tracker](./publishing-the-site) to your own website. 

The following sections cover [managing your tracker](./managing-your-development-tracker) and harnessing public [engagement](./harnessing-reader-engagement) and support. Finally, there are some tips for [launching your tracker](./launching-your-tracker) to your audience and how to [get in touch with us](./getting-in-touch-with-us) if you have questions or suggestions. 
