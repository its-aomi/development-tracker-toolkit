...
## Here’s a checklist of tasks you should have completed before launching your tracker:



- Set up your [Airtable base](./setting-up-your-airtable-base).
- Determine your [data sources and structure](./starting-with-the-data). 
- Collect your data, [enter it in Airtable](./using-the-projects-table), review records and set them as ready to publish. 
- Set up [the site](./setting-up-the-site).
- Customize [the site](./customizing-the-site). At the very least, you’ll need to adjust:
...
- Publish the tracker [to your website](./publishing-the-site) and repeat testing.
...
- Finalize and formalize [workflows](./managing-your-development-tracker) with your team and create documentation.
