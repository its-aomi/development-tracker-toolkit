...
- A source-code editor installed on your computer. [Visual Studio Code](https://code.visualstudio.com/) is a popular choice that integrates well with GitHub, and is what we use in these instructions. With VSCode, you will also need to install the [GitHub Pull Requests and Issues extension](https://marketplace.visualstudio.com/items?itemName=GitHub.vscode-pull-request-github).
...
## Other needs from within or outside your newsroom
