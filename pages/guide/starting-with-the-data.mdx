...
Data collection is the most challenging part of this process to give instructions for, since it will vary so much by location. Here is what we did, as well as some other advice and considerations.
...
Our first step was to create a structure for our data, which you will be replicating for your site. You can see this laid out in more detail in the [Airtable sections](./guide/organize-your-data-airtable-basics), but most simply, each development project is its own record and includes a geographic location and other standard elements, like an attached image and the project’s status, selected from a set number of options. 
...
For more about the types and format of information to collect for each record, see the [Airtable sections](./guide/organize-your-data-airtable-basics). For more about workflows for adding and managing your data, see the [Managing your tracker section](./guide/managing-your-development-tracker#workflows-for-data-and-managing-the-tracker).
