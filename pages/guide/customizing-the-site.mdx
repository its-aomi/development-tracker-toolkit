...
- Within VSCode, delete the `guide` directory that's inside `pages`.
- In the file `components/Header.js`, remove lines 24 through 27 (inclusive) to remove the reference to the guide.
