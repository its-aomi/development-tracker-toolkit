...
Follow these steps to customize your version of the tracker to pull in the correct geography, as well as your publication's name and your site name in areas across the site. Here, you can also edit the copy that appears on main pages of the site (the homepage, tips page, about page and contact page).
...
This is the site's About page. You can edit text within sections we've included, like your audience can use the site and who can collaborate on this project. **Please keep the final section, "[Credits](./about#credits)," on your site** -- it includes creator credits and a link back to this toolkit.
