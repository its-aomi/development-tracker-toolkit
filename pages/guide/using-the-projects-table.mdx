...
Your Projects table includes several pre-configured views that may help you with managing your data. You can delete any views that you don’t end up using, edit them or add new ones. See more about [using and editing views here](https://support.airtable.com/hc/en-us/articles/360042311914-What-is-a-view-). 
