...
This tracker was built using the open-source [Local Real Estate Development Tracker Toolkit](https://airtable-tracker-toolkit.netlify.app/), built by [Jimmy McBroom](https://github.com/jmcbroom) and Kate Abbey-Lambertz, with design support from [Lindsay Farris](https://www.farrislindsay.com/). The toolkit was created with support from the [Reynolds Journalism Institute](https://rjionline.org/). 
